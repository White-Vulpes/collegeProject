...
function background(props) {
  ...
  return (
    <div className='backgroundContainer'>
        <svg width='100%' height='100%' viewBox='10 10 2000 1500' style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            <defs>
                <circle style={{stroke: 'var(--secondary)'}} vectorEffect="non-scaling-stroke" id="a" fill="none" strokeWidth="5" r="315" />
            ...
            <g transform="translate(1000 750)">
                <g transform="">
                    <circle style={{fill: 'var(--secondary)'}} fillOpacity="1" r="10" />
                    <g className='innerTrans' transform="rotate(-24 0 0)">
                        {/* here */}
                    ...
                    <g id="z" className='midTrans' transform="rotate(10.8 0 0)">
                        {/* here */}
                        <g transform="">
                        <use href="#b" />
                    ...
                    <g transform="">
                        <g className='outerTrans' transform="rotate(-10.8 0 0)">
                            {/* here */}
                        <g transform="">
